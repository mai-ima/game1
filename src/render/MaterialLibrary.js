...
const PRESETS = {
  /* ---- 建材 ---- */
  concrete:        { tex: 'concrete',     repeat: 0.5,  params: { roughness: 1, metalness: 1 } },
  concreteFloor:   { tex: 'concrete',     repeat: 0.35, params: { roughness: 1, metalness: 1, color: 0xb8b6b0 }, seed: 88 },
  paintedWall:     { tex: 'paintedWall',  repeat: 0.4,  params: { roughness: 1, metalness: 1 } },
  paintedWallBlue: { tex: 'paintedWall',  repeat: 0.4,  params: { roughness: 1, metalness: 1, color: 0x8fa4b8 }, seed: 302 },
  plaster:         { tex: 'plaster',      repeat: 0.45, params: { roughness: 1, metalness: 1 } },
  brick:           { tex: 'brick',        repeat: 0.32, params: { roughness: 1, metalness: 1 } },
  brickPale:       { tex: 'brick',        repeat: 0.32, params: { roughness: 1, metalness: 1, color: 0xc9bda8 }, seed: 555 },
  rock:            { tex: 'rock',         repeat: 0.28, params: { roughness: 1, metalness: 1 } },
  tile:            { tex: 'tile',         repeat: 0.55, params: { roughness: 1, metalness: 1 } },
  paving:          { tex: 'paving',       repeat: 0.3,  params: { roughness: 1, metalness: 1 } },

  /* ---- 地面 ---- */
  asphalt:         { tex: 'asphalt',      repeat: 0.28, params: { roughness: 1, metalness: 1 } },
  dirt:            { tex: 'dirt',         repeat: 0.3,  params: { roughness: 1, metalness: 1 } },
  sand:            { tex: 'sand',         repeat: 0.25, params: { roughness: 1, metalness: 1 } },
  gravel:          { tex: 'gravel',       repeat: 0.5,  params: { roughness: 1, metalness: 1 } },

  /* ---- 金属 ---- */
  rustedMetal:     { tex: 'rustedMetal',  repeat: 0.5,  params: { roughness: 1, metalness: 1 } },
  paintedMetal:    { tex: 'paintedMetal', repeat: 0.6,  params: { roughness: 1, metalness: 1 } },
  paintedMetalTan: { tex: 'paintedMetal', repeat: 0.6,  params: { roughness: 1, metalness: 1, color: 0xc8b389 }, seed: 71 },
  ...
  corrugated:      { tex: 'corrugated',   repeat: 0.45, params: { roughness: 1, metalness: 1 } },
  ...
  /* ---- 有機物 / 布 ---- */
  wood:            { tex: 'wood',         repeat: 0.5,  params: { roughness: 1, metalness: 1 } },
  woodDark:        { tex: 'wood',         repeat: 0.5,  params: { roughness: 1, metalness: 1, color: 0x8a6a4c }, seed: 909 },
  plywood:         { tex: 'plywood',      repeat: 0.45, params: { roughness: 1, metalness: 1 } },
