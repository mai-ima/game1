...
export const ICONS = {
  ...
  /** マップ見学: 地図の上を飛ぶ視点（羅針盤付きの俯瞰） */
  mapview: (o) => svg(`
    <path d="M2.6 8.2l5.4-2.2 5.4 2.2 5.4-2.2v9.6l-5.4 2.2-5.4-2.2-5.4 2.2z" opacity=".55" />
    <path d="M8 6v9.6M13.4 8.2v9.6" opacity=".35" />
    <circle cx="16.4" cy="7.6" r="4.4" />
    <path d="M18.2 5.8l-1 3-3 1 1-3z" />`, o),
